...
class AddCourses extends React.Component<any, any> {
    @resolve("client")
    ...
    techerDat = (stateVariable) => {
        ...
        const data = {
            id: generateId(),//stateVariable.id,
        ...
        console.log("Response for dummy is " + JSON.stringify(data));

        this.client.post(`/institute/${this.institute.id}/course`, data).then((response) => {
            console.log("Response for dummy is " + JSON.stringify(response.data));

            const dataT = response.data;
            this.props.setBover(1)
            RefreshCourse.next()
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                        <Grid container spacing={2} className="mavde">
                            <Grid item xs={4}>
                                <button className="btn_custond" onClick={this.techerSubit}>Add</button>
                            </Grid>
                        </Grid>
                    </Grid>
                </Grid>
