const Privacy = () => {
    ...
    return (
        ...
        <p>Effective date: 2021-12-16</p>
        <p>1. <b>Introduction</b></p>
        <p>Welcome to <b> Teaching Aura</b>.</p>
        <p><b>Teaching Aura</b> (“us”, “we”, or “our”) operates <b>www.teachingaura.com</b> (hereinafter referred to
            as <b>“Service”</b>).</p>
        <p>Our Privacy Policy governs your visit to <b>www.teachingaura.com</b>, and explains how we collect, safeguard
            and
        ...
        <p><b>SERVICE</b> means the www.teachingaura.com website operated by Teaching Aura.</p>
        ...
        <p>While using our Service, we may ask you to provide us with certain personally identifiable information that
            can
            be used to contact or identify you (<b>“Personal Data”</b>). Personally identifiable information may
            include,
        ...
        <p>Teaching Aura uses the collected data for various purposes:</p>
        ...
        <p>If you are located outside USA and choose to provide information to us, please note that we transfer the
            data,
            including Personal Data, to USA and process it there.</p>
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement
            to
            that transfer.</p>
        <p>Teaching Aura will take all the steps reasonably necessary to ensure that your data is treated securely and
            in
        ...
        <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our
            systems, please email us at <b>Rishabhj@teachingaura.com</b>.</p>
        ...
        <p>CalOPPA is the first state law in the nation to require commercial websites and online services to post a
            ...
            (and conceivable the world) that operates websites collecting personally identifiable information from
        ...
        <p>0.4. users are able to change their personal information by emailing us at <b>Rishabhj@teachingaura.com</b>.
        </p>
        ...
        <p><b>0.3. To stop selling your personal information. We don’t sell or rent your personal information to any
            third
            parties for any purpose. We do not sell your personal information for monetary consideration. You are the only owner of
            your
        ...
        <p>To exercise your California data protection rights described above, please send your request(s) by
            email: <b>Rishabhj@teachingaura.com</b>.</p>
        <p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer
            Privacy
            Act. To find out more, visit the official California Legislative Information website. The CCPA took effect
            on
            01/01/2020.</p>
        ...
        <p>If you have any questions about this Privacy Policy, please contact us by
            email: <b>Rishabhj@teachingaura.com</b>.
        </p>
        <p style={{marginTop: "5em", fontSize: "0.7em"}}>This <a href="https://policymaker.io/privacy-policy/">Privacy
            Policy</a> was created for <b>www.teachingaura.com</b> by <a
            href="https://policymaker.io">PolicyMaker.io</a> on
            2021-12-16.</p>
        </body>
    );
}
